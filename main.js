...
var SmartWritePublisher = class extends import_obsidian5.Plugin {
    ...
    try {
      ...
      this.registerObsidianProtocolHandler("smartwrite-publisher-auth", async (params) => {
        ...
        if (user_login && password) {
          ...
          new import_obsidian5.Notice(`Successfully authenticated WordPress user: ${user_login}`);
          ...
          new import_obsidian5.Notice("WordPress authentication failed: Missing credentials.");
        }
      });
